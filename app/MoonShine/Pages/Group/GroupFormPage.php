...
class GroupFormPage extends FormPage
{
    ...
    */
    ...
    {
        $title = __('group.'.$this->title.'_c');
        if($this->getResource()->getItem()?->group){
            $title = __('group.'.$this->title).': <b>'.$this->getResource()->getItem()?->group.'</b>';
        }
    ...
    {
        if(!$this->getResource()->getItem()?->group){
            $ret['group-index-page'] = __('group.groups');
            $ret['#'] = __('group.'.$this->title.'_c');
            return $ret;
        }
