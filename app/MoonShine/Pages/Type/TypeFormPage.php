...
class TypeFormPage extends FormPage
{
    protected string $title = 't_edit';
    /**
    ...
    */
    ...
    {
        $title = __('type.'.$this->title.'_c');
        if($this->getResource()->getItem()?->type){
            $title = __('type.'.$this->title).': <b>'.$this->getResource()->getItem()?->type.'</b>';
        }
    ...
    {
        if(!$this->getResource()->getItem()?->type){
            $ret['type-index-page'] = __('type.types');
            $ret['#'] = __('type.'.$this->title.'_c');
            return $ret;
        }
